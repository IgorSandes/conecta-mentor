    ...
    <div className="w-full max-w-2xl bg-white p-10 rounded-3xl shadow-2xl border border-gray-200">
      ...
      <div className="flex justify-center gap-6 mb-8">
        <button
          ...
          className={`flex items-center justify-center gap-2 w-40 py-3 rounded-xl font-semibold transition-all shadow-sm text-white bg-blue-600 hover:bg-blue-700 ${
            tipo === "mentor" ? "ring-4 ring-blue-400" : "opacity-80"
          }`}
        >
          <FaChalkboardTeacher />
          MENTOR
        ...
        <button
          ...
          className={`flex items-center justify-center gap-2 w-40 py-3 rounded-xl font-semibold transition-all shadow-sm text-white bg-blue-600 hover:bg-blue-700 ${
            tipo === "mentorado" ? "ring-4 ring-blue-400" : "opacity-80"
          }`}
        >
          <FaUserGraduate />
          MENTORADO
